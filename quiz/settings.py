# Django settings for quiz/quiz project.
...
DB_NAME = 'db_quiz'
DB_PWD = 'ghhpasswd'
CACHE_BACKEND_URL = 'file:///home/ghh/quiz/quiz/cache_backend?timeout=60&max_entries=400'
APPS_STATICFILES_DIRS =  os.path.join(HERE , 'quiz/static/')
